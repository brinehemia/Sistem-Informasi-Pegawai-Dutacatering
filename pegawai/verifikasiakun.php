        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-pane active" id="tab_1-1">
              ...
              <div class="box-body">
                ...
                <form class="form-horizontal" action="../controller/pelamarcontroller.php?action=addverifikasi" Method="POST">
                <?php
               $readidwawancara = $con->readidwawancara($_GET['iduser']); 
               $dataidwawancara = mysqli_fetch_array($readidwawancara);
               
              ?>
                <input name="postidverifikasi" type="hidden" value="<?php $con->autocode_verifikasi() ?>" readonly>
                <input name="postidwawancara" type="hidden" value="<?php echo $dataidwawancara['idwawancara'] ?>" readonly>
