    ...
    <div class="row">
        <div class="col-md-3">
          ...
          ?>
              ...
              <img class="profile-user-img img-responsive img-circle" src="../assets/image/admin.jpg" alt="User profile picture">

              <h3 class="profile-username text-center">Selamat Datang, <?php echo $data['namapelamar']?></h3>
              ...
              <p><b>Informasi pribadi</b></p>
                <table height="170px" border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td><b>:</b>&nbsp <?php echo $data['namapelamar']?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><b>:</b>&nbsp <?php echo $data['no_telp']?></td>
                    </tr>
