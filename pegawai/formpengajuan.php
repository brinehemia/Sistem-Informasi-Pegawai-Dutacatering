      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-spinner"></i> Form Pengajuan Pegawai</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <span class="input-group-addon"><i class="fa fa-group"></i></span>
                      ...
                      <select class="form-control">
                          <option>Pilih kategori pengajuan:</option>
                      </select>
             ...
             <i class="fa fa-check-circle-o"></i>&nbsp
                  ...
                  <label class="form-group">Perihal pengajuan :</label>
              ...
              <div class="form-group">
              <i class="fa fa-check-circle-o"></i>&nbsp
                  <label stye="padding-left:50px;" class="form-group">Isi pengajuan :</label>
                    <textarea name="postisi" id="" class="form-control" style="height: 130px"></textarea>
              </div>
