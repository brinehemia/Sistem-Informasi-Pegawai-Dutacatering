              ...
              <div class="table-responsive mailbox-messages">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                    <a class="btn btn-primary" href="../controller/requestcontroller.php?aksi=setujui&idsurat=<?php echo $fetch['idrequestpegawai']; ?>"><i class="fa fa-check"></i>&nbspSetujui</a>
                    <a class="btn btn-warning" href="formbalasantolak.php?nomorsurat=<?php echo $fetch['idrequestpegawai']; ?>"><i class="fa fa-close"></i>&nbsp&nbspTolak</a>
                   </td>
