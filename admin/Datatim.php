  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body" >
           <table  id="example2" class="table table-bordered table-hover">
                ...
                <td><?php echo $fetch['idtim']?></td>
                  ...
                  <td>
                    <a class="btn btn-danger" href="../controller/jobdesktimcontroller.php?action=hapustim&idtim=<?php echo $fetch['idtim']?>"><i class="fa fa-trash"></i></a> 
                    <a class="btn btn-success" href="formpembagiantim.php?idtim=<?php echo $fetch['idtim']?>"><i style="width:12px;" class="fa fa-user-plus"></i></a>
        ...
        <a class="btn bg-olive" type="button" href="formjobdesk.php"><i style="width:12px;" class="fa fa-file-text"></i>&nbsp&nbspForm Jobdesk</a>
        <a class="btn btn-warning bg-orange" href="formtim.php"><i style="width:12px;" class="fa fa-file-text"></i>&nbsp&nbspForm tim</a>
