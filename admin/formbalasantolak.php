      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
            <br>
             <center> <h2 class="box-title"><b>Surat Penolakan Pengajuan Penambahan Pegawai</b> </h2> </center>
             <br><br>
            ...
            <div class="box-body no-padding">
              ...
              <div class="mailbox-read-message"><br>
                ...
                <form action="../controller/requestcontroller.php?aksi=penolakan" method="POST">
                <br>
                <input name="postidbalasan" type="hidden" value="<?php echo $conn->autocode_balasan() ?>">
                <input name="postnomorsurat" type="hidden" value="<?php echo $data['idrequestpegawai']; ?>">
                <input name="postidsurat" type="hidden" value="<?php echo $data['idrequestpegawai']; ?>">
                <b>Isi alasan penolakan pengajuan:</b><br><br>
                <textarea style="resize:none;" class="form-control" name="postisi" id="" rows="6" placeholder="...."></textarea>
