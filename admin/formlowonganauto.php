      ...
      <div class="col-md-9">
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
             <!-- form start -->
            <?php
             $read = $conn->readreqpegawai($_GET['nomorsurat']); 
            ...
            <div class="tab-pane active" id="tab_1-1">
                ...
                <input name="postkodedivisi" type="hidden" value="<?php echo $data['kodedivisi'] ?>" readonly>
                
                    <label for="fornama">Nama Pekerjaan:</label>
                    <div class="form-group input-group">
                        <span class="input-group-addon"><i class="fa fa-list"></i></span>
                        <input value="<?php echo $data['namapekerjaan'] ?>" name="postnama" type="text" class="form-control" id="fornama" placeholder="lowongan yang akan dibuka">
                    </div>

                    <label for="forpassword">Jumlah:</label><small>   <a color="red">*)</a> Masukkan angka lowongan yang dibutuhkan</small>
                   <div class="form-group input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input value=" <?php echo $data['jumlahdibutuhkan'] ?>" name="postjumlah" type="text" style="width:100px;" class="form-control" id="forpassword" placeholder="Jumlah kuota"> 
                        <input readonly value="Divisi <?php echo $data['namadivisi'] ?>" type="text" style="width:200px;" class="form-control"  >  
                   </div>


                    <label for="forpassword">Syarat dibutuhkan:</label>
                   <div class="form-group input-group">
                        <textarea name="postsyarat" style="resize: none;" cols="120" rows="6" type="text" class="form-control" id="editor1" ><?php echo $data['syarat'] ?></textarea>
                    </div>
